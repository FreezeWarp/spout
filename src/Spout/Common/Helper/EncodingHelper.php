...
use Box\Spout3\Common\Exception\EncodingConversionException;
...
class EncodingHelper
{
    ...
    /**
     * @param \Box\Spout3\Common\Helper\GlobalFunctionsHelper $globalFunctionsHelper
     */
     ...
     * @throws \Box\Spout3\Common\Exception\EncodingConversionException If conversion is not supported or if the conversion failed
