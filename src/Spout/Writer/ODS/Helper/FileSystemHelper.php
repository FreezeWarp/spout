...
namespace Box\Spout3\Writer\ODS\Helper;
...
use Box\Spout3\Writer\ODS\Manager\WorksheetManager;
...
class FileSystemHelper extends \Box\Spout3\Common\Helper\FileSystemHelper implements FileSystemWithRootFolderHelperInterface
{
     ...
     *
     * @throws \Box\Spout3\Common\Exception\IOException If unable to create the folder or the "manifest.xml" file
     * @return FileSystemHelper
     */
