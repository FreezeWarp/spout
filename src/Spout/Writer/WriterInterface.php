...
interface WriterInterface
{
     ...
     * @throws \Box\Spout3\Common\Exception\IOException If the writer cannot be opened or if the given path is not writable
     ...
     * @throws \Box\Spout3\Common\Exception\IOException If the writer cannot be opened
     * @return WriterInterface
     */
     ...
     * @throws \Box\Spout3\Writer\Exception\WriterNotOpenedException If the writer has not been opened yetthe writer
     * @throws \Box\Spout3\Common\Exception\IOException If unable to write data
     * @return WriterInterface
     */
     ...
     * @throws \Box\Spout3\Common\Exception\InvalidArgumentException If the input param is not valid
     * @throws \Box\Spout3\Writer\Exception\WriterNotOpenedException If the writer has not been opened yet
     * @throws \Box\Spout3\Common\Exception\IOException If unable to write data
     * @return WriterInterface
     */
