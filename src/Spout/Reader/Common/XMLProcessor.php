...
namespace Box\Spout3\Reader\Common;
...
class XMLProcessor
{
    ...
    /**
     * @param \Box\Spout3\Reader\Wrapper\XMLReader $xmlReader XMLReader object
     */
     ...
     *
     * @throws \Box\Spout3\Reader\Exception\XMLProcessingException
     * @return void
     */
