...
use Box\Spout3\Reader\Exception\NoSheetsFoundException;
use Box\Spout3\Reader\IteratorInterface;
use Box\Spout3\Reader\XLSX\Manager\SheetManager;
...
{
    /** @var \Box\Spout3\Reader\XLSX\Sheet[] The list of sheet present in the file */
    protected $sheets;
     ...
     *
     * @return \Box\Spout3\Reader\XLSX\Sheet
     */
