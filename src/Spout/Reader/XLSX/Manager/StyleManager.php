...
class StyleManager
{
     ...
     *
     * @param \Box\Spout3\Reader\Wrapper\XMLReader $xmlReader XML Reader positioned on the "numFmts" node
     * @return void
     */
     ...
     *
     * @param \Box\Spout3\Reader\Wrapper\XMLReader $xmlReader XML Reader positioned on the "cellXfs" node
     * @return void
     */
