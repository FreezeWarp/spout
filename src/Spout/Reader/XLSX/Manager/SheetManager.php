...
namespace Box\Spout3\Reader\XLSX\Manager;
...
class SheetManager
{
    ...
    /** @var \Box\Spout3\Common\Manager\OptionsManagerInterface Reader's options manager */
    ...
    /** @var \Box\Spout3\Common\Helper\Escaper\XLSX Used to unescape XML data */
    protected $escaper;
     ...
     * @param \Box\Spout3\Reader\XLSX\Manager\SharedStringsManager $sharedStringsManager Manages shared strings
     * @param \Box\Spout3\Common\Helper\Escaper\XLSX $escaper Used to unescape XML data
    ...
    /**
     * @param \Box\Spout3\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<workbookPr>" starting node
    ...
    /**
     * @param \Box\Spout3\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<workbookView>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
    ...
    /**
     * @param \Box\Spout3\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<sheet>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
     ...
     *
     * @param \Box\Spout3\Reader\Wrapper\XMLReader $xmlReaderOnSheetNode XML Reader instance, pointing on the node describing the sheet, as defined in "workbook.xml"
     * @param int $sheetIndexZeroBased Index of the sheet, based on order of appearance in the workbook (zero-based)
     * @param bool $isSheetActive Whether this sheet was defined as active
     * @return \Box\Spout3\Reader\XLSX\Sheet Sheet instance
     */
