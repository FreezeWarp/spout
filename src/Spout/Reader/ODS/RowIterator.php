...
use Box\Spout3\Reader\Exception\IteratorNotRewindableException;
use Box\Spout3\Reader\Exception\XMLProcessingException;
use Box\Spout3\Reader\IteratorInterface;
use Box\Spout3\Reader\ODS\Creator\InternalEntityFactory;
...
class RowIterator implements IteratorInterface
{
     ...
     *
     * @throws \Box\Spout3\Reader\Exception\IteratorNotRewindableException If the iterator is rewound more than once
     * @return void
     */
    ...
    /**
     * @param \Box\Spout3\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-row>" starting node
    ...
    /**
     * @param \Box\Spout3\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-cell>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
